    ...
    yield new Promise(function (resolve, reject) {
        ...
        if (header) {
            resolver_1.default.lookup(header.did).then(response => {
                ...
                var key = did_auth_1.default.getKeyFromDDO(response.ddo, header.key);
                console.log(key);
                if (key) {
                    ctx.body = key;
                    resolve(next());
...
indexRouter.post('/.identity/:id', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield resolver_1.default
        ...
        var key = did_auth_1.default.getKeyFromDDO(ddo);
...
indexRouter.get('/.identity/:id/profile', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (!ctx.params.id) {
        ...
        yield resolver_1.default.lookup(ctx.params.id).then(response => {
