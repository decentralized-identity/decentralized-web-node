...
## ​2.2.​ Mobile Device Plus Cloud Storage
...
## ​2.3.​ Multiple Devices (Single User) Plus Cloud Storage

When adding more devices managed by a single user, the vault can be used to
synchronize data across devices.

## ​2.4.​ Multiple Devices (Multiple Users) Plus Cloud Storage
...
IoT / machine to machine / Skynet...

Data only exists on a cloud service. (Password manager use case?;
biometric-based use case?)

Multi-cloud / hybrid cloud deployment scenarios - important to enterprise shops

## ​2.6. Self-Hosted and/or Home-based Server?

Alice wants to host her own SDS software instance, on her own server.

## 2.7 Support Low Power Devices/Non-private computing
